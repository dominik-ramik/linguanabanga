import { _t } from "./__deprecated__I18n.js";
...
let _cachedLowerCase = {}
export function cachedLowerCase(text) {
    if (typeof text !== 'string' && !(text instanceof String)) return ""

    if (!Object.prototype.hasOwnProperty.call(_cachedLowerCase, text)) {
        _cachedLowerCase[text] = text.toLowerCase()
    }
    
    return _cachedLowerCase[text]
}

let _cachedLowerCaseAccentless = {}
export function cachedLowerCaseAccentless(text) {
    text = cachedLowerCase(text)

    if (!Object.prototype.hasOwnProperty.call(_cachedLowerCaseAccentless, text)) {
        _cachedLowerCaseAccentless[text] = text.normalize("NFD").replace(/[\u0300-\u036f]/g, "");
    }
    
    return _cachedLowerCaseAccentless[text]
}
...
export function getGradedColor(type) {
    if (type == "taxa") {
