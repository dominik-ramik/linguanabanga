...
Lingua Nabanga is a web application for building and browsing multilingual, project-based dictionaries. It loads structured data from JSON, supports Markdown content, and provides fast text search with configurable fuzziness.
...
A live reference implementation is available at https://dictionary.pvnh.net
